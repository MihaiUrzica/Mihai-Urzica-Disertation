...
expert_conv = VGG16(weights = 'imagenet', include_top = False,input_shape=(325,325,3))
...
tweaked_model.add(Reshape((325,325,3)))
tweaked_model.add(expert_conv)
tweaked_model.add(GlobalAveragePooling2D())

tweaked_model.add(Dense(325, activation = 'relu')) 
...
tweaked_model.save("C:/Users/Mihai/dizertatie/Model2/model2.h5'")
